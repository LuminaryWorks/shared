...
LuminaryWorks 生态六个组织/产品的官方 Logo，以及**统一** UI 配色令牌。本目录是全生态唯一品牌资源源。

生态 **不为六个产品规定独立 accent**。产品用各自 Logo 与文案区分；共享 UI / 文档站 / 登录页主色一律品牌蓝 `#1677ff`。
...
- **统一主色**：品牌蓝 `#1677ff`；青 `#18a0fb` → 薄荷 `#21d4a8` 仅作 hero / 高亮点缀，不替代主色
- **格式**：全系 SVG

母品牌 Logo 的光束渐变是工坊标识本身，不是六产品配色表。
